    ...
    <PDFViewer  style = {styles.viewer}>
      <Document>
        <Page size="A4" style={styles.page}>
          ...
          <View>
          <Text style={{fontSize:20, marginLeft:45, marginTop:60, marginBottom:40, fontWeight:"bold"}}> DIGITAL LOADING FORM </Text>

          <Text style={{fontSize:12, marginLeft:25, fontWeight:"bold"}}>LOADING SUMMARY</Text>

            <View style={{border:"1px solid black" , marginTop:5, marginLeft:25 , marginRight:25, marginBottom:25 }}>
              ...
              <View style={{ flexDirection: "row" }}>
                ...
                <Text style={styles.cell}>{getStationName(decodedToken?.staff._kf_Station)}</Text>
                <Text style={styles.headerCell}> CWS ID	</Text>
                <Text style={styles.cell}>{getStationID(decodedToken?.staff._kf_Station)}</Text>
              </View>
              <View style={{ flexDirection: "row" }}>
                ...
                <Text style={styles.cell}>  {reportById?.weight_received_bags}</Text>
              </View>
              <View style={{ flexDirection: "row" }}>
                ...
                <Text style={styles.cell}>{reportById?.total_bags_received}</Text>
              </View>
              <View style={{ flexDirection: "row" }}>
                ...
                <Text style={styles.cell}> {reportById?.gross_weight_parch_received}</Text>
              </View>
              <View style={{ flexDirection: "row" }}>
                ...
                <Text style={styles.cell}>{reportById?.expected_delivery_date}</Text>
              </View>
              <View style={{ flexDirection: "row" }}>
            ...
            <View style={{marginLeft:25, marginRight:25}}>
                <Text style={{fontWeight:"bold", fontSize:12, marginBottom:5}}>LOADING DETAILS</Text>
              <View style={{ flexDirection: "row" }}>
              ...
              {reportLotById?.map((parchment, index) => (
                <View key={index} style={{ flexDirection: "row" }}>
                  ...
                  <Text style={styles.Bodycell}> {getCherrylotid(parchment.parch_lot_ID)}</Text>
                  <Text style={styles.Bodycell}> {parchment.bags_loaded}</Text>
                  <Text style={styles.Bodycell}>{parchment.weight}</Text>
                  <Text style={styles.Bodycell}>  {parchment.bags_of_parchment_left === 0 ? "No":"Yes"}</Text>
                  <Text style={styles.Bodycell}>{parchment.bags_of_parchment_left} bags</Text>
                  {/* Add other cells */}
                </View>
                ...
                <Text  style={styles.bodyHeaderCellTotal}>{reportById?.bags}</Text>
                <Text  style={styles.bodyHeaderCellTotal}>{reportById?.weight}</Text>
                <Text style={styles.bodyHeaderCellTotal}></Text>
                <Text  style={styles.bodyHeaderCellTotal}></Text>
