...
const [certificate, setCertificate] = useState()
  ...
  const openModal = (cherryLotId,dry) => {
    ...
    setDryToParch(dry)
    console.log("assign parchement", dry)
   
    setModalOpen(true);
  };
  const closeModal = () => {
    // setCherryLotToAssign(null)
    setModalOpen(false);
  };
...
//   const handleConfirmAssign = (cherry_lot_id) => {
//     const data = {
//         cherry_lot_id: cherry_lot_id,
//         grade: selectedGrade 
//     };

//     dispatch(assigParchment(data))
//         .then(() => {
//             console.log("Parchment assigned successfully!");
//             closeModal(); 
//         })
      
//         .catch((error) => {
//             console.error("Failed to assign parchment:", error);
               ...
               <div className="flex pl-2 space-x-1 mt-1">
                 ...
                 <div>
                   ...
                   >
                     ...
                     <option value="closed">{parchment.data.grade}</option>
                   </select>
                 </div>
               </div>
               <div className="flex pl-2 space-x-1 mt-1">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="closed">{selectedCertification}</option>
                  </select>
                </div>
              </div>
              <div className="flex pl-2 space-x-1 mt-1">
