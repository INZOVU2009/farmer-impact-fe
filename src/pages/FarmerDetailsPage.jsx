...
function FarmerDetailsPage() {
  ...
  const farmerChildren = (_kf_Household) => {
    const household = allHouseholds?.find(
      (household) => household.__Kp_Household === _kf_Household
    );
    return household ? household.children : "";
  };
  const children = farmerChildren(selectedFarmer?._kf_Household);
  return (
          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className=" dark:bg-slate-800  rounded-sm border border-slate-200 dark:border-slate-700 mb-2">
              <div className="flex gap-20  ml-40">
                <div className="grid  ">
                  ...
                  <input
                    type="text"
                    value={selectedFarmer?.Year_Birth}
                    className="rounded-lg mb-2"
                  />
                </div>
                <div className="grid  ">
            ...
            <div className=" dark:bg-slate-800  rounded-sm border border-slate-200 dark:border-slate-700 mb-2">
              <div className="flex gap-20  ml-40">
                ...
                <div className="grid  ">
                  <p className="mt-3">National.ID</p>
                  <input
                    type="text"
                    value={selectedFarmer?.National_ID_t}
                    className="rounded-lg mb-2"
                  />
                </div>
              </div>
            ...
            <div className=" dark:bg-slate-800  rounded-sm border border-slate-200 dark:border-slate-700 mb-2">
              <div className="flex gap-20  ml-40">
                <div className="grid ">
                  ...
                  <input
                    type="text"
                    value={selectedFarmer?.Position}
                    className="rounded-lg mb-2"
                  />
                </div>
                <div className="grid  ">
                  <p className="mt-3">CAFE_ID</p>
                  <input
                    type="text"
                    value={selectedFarmer?.CAFE_ID}
                    className="rounded-lg mb-2"
                  />
                </div>
              </div>
            ...
            <div className=" dark:bg-slate-800  rounded-sm border border-slate-200 dark:border-slate-700 mb-2">
              <div className="flex gap-20  ml-40">
                <div className="grid  ">
                  <p className="mt-3">SAN_ID</p>
                  <input
                    type="text"
                    value={selectedFarmer?.SAN_ID}
                    className="rounded-lg mb-2"
                  />
                </div>
                <div className="grid ">
                  <p className="mt-3">UTZ_ID</p>
                  <input
                    type="text"
                    value={selectedFarmer?.UTZ_ID}
                    className="rounded-lg mb-2"
                  />
                </div>
              </div>
            ...
            <div className=" dark:bg-slate-800  rounded-sm border border-slate-200 dark:border-slate-700 mb-2">
              <div className="flex gap-20  ml-40">
                <div className="grid ">
                  <p className="mt-3">Trees</p>
                  <input
                    type="text"
                    value={selectedFarmer?.Trees}
                    className="rounded-lg mb-2"
                  />
                </div>
                <div className="grid ">
                  <p className="mt-3">Trees producing</p>
                  <input
                    type="text"
                    value={selectedFarmer?.Trees_Producing}
                    className="rounded-lg mb-2"
                  />
                </div>
              </div>
            ...
            <div className=" dark:bg-slate-800  rounded-sm border border-slate-200 dark:border-slate-700 mb-2">
              <div className="flex gap-20 ml-40">
                ...
                <div className="grid ">
                  <p className="mt-3">Number Of Plots</p>
                  <input
                    type="text"
                    value={selectedFarmer?.number_of_plots_with_coffee}
                    className="rounded-lg mb-2"
                  />
                </div>
              </div>
            ...
            <div className=" dark:bg-slate-800  rounded-sm border border-slate-200 dark:border-slate-700 mb-2">
              <div className="flex gap-20  ml-40">
                <div className="grid  ">
                  <p className="mt-3">Marital_Status</p>
                  <input
                    type="text"
                    value={selectedFarmer?.Marital_Status}
                    className="rounded-lg mb-2"
                  />
                </div>
                <div className="grid ">
                  <p className="mt-3">Reading Skills</p>
                  <input
                    type="text"
                    value={
                      selectedFarmer?.Reading_Skills || "No Reading Skills"
                    }
                    className="rounded-lg mb-2"
                  />
                </div>
            ...
            <div className=" dark:bg-slate-800  rounded-sm border border-slate-200 dark:border-slate-700 mb-2">
              <div className="flex gap-20  ml-40">
                <div className="grid  ">
                  <p className="mt-3">Math_Skills</p>
                  <input
                    type="text"
                    value={selectedFarmer?.Reading_Skills || "No Math Skills"}
                    className="rounded-lg mb-2"
                  />
                </div>
                <div className="grid ">
                  <p className="mt-3">Group ID</p>
            ...
            <div className=" dark:bg-slate-800  rounded-sm border border-slate-200 dark:border-slate-700 mb-2">
              <div className="flex gap-20 ml-40">
                <div className="grid  ">
                  <p className="mt-3">Updated at</p>
                  <input
                    type="text"
                    value={selectedFarmer?.updated_at || ""}
                    className="rounded-lg mb-2"
                  />
                </div>
                <div className="grid ">
                  <p className="mt-3">Uploaded at</p>
                  <input
                    type="text"
                    value={selectedFarmer?.uploaded_at || ""}
                    className="rounded-lg mb-2"
                  />
                </div>
              </div>
            ...
            <div className=" dark:bg-slate-800  rounded-sm border border-slate-200 dark:border-slate-700 mb-2">
              <div className="flex gap-20 ml-40">
                <div className="grid  ">
                  <p className="mt-3">Registered by</p>
                  <input
                    type="text"
                    value={selectedFarmer?.created_by}
                    className="rounded-lg mb-2"
                  />
                </div>
              </div>
