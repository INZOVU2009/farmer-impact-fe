...
import TrainingSessionsTable from "../../partials/dashboard/training/TrainingSessionsTable";
import { fetchAllTrainings } from "../../redux/actions/trainings/fetchAllTrainings.action";
...
import { fetchAllTrainingsAttendanceSheet } from "../../redux/actions/trainingAttendnces/trainingAttendanceSheet.action";
function TrainingSessionsPage() {
  ...
  const [allAttendanceSheets, setAllAttendanceSheets] = useState([]);
  ...
  const { attendenceSheet } = useSelector((state) => state.fetchAllAttendenceSheet);
  ...
  useEffect(() => {
    dispatch(fetchAllTrainingsAttendanceSheet(currentPage, itemsPerPage));
  }, [dispatch, currentPage, itemsPerPage]);

  useEffect(() => {
    if (attendenceSheet) {
      setAllAttendanceSheets(attendenceSheet?.data?.attendance);
    }
  }, [attendenceSheet]);

  console.log("hehe", allAttendanceSheets);
          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="grid grid-cols-12 gap-6">
              <TrainingSessionsTable 
               attendances={allAttendanceSheets}
               handleNextPage={handleNextPage}
               handlePrevPage={handlePrevPage}
               itemsPerPage={itemsPerPage}
               currentPage={currentPage}
               totalItems={attendenceSheet?.data?.totalItems}
