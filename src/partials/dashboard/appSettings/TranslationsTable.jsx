                    ...
                    <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                      ...
                      <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <div className=" flex flex-row gap-1">
                          <MdEdit className=" text-green-500 border-2 border-green-500 rounded-full  text-3xl  p-1 cursor-pointer  hover:bg-green-500 hover:text-white" />
                          <RiDeleteBin6Line className="text-red-500 border-2 border-red-500 rounded-full text-3xl p-1 cursor-pointer hover:bg-red-500 hover:text-white" />
