...
const ParchmentReceptionDetailsTable = ({
   reportById, reportLotById, stationName, StationID,decodedToken}) => {
...
export default ParchmentReceptionDetailsTable;
